...
// $this->logger->debug(setLevel($this->logger->debug(LEVEL_WARNING);
// $this->logger->debug(setLevel($this->logger->debug(LEVEL_ERROR);
// $this->logger->debug(setLevel($this->logger->debug(LEVEL_SEVERE);
